...
- Initial public release of **VStacks**.
...
- Requires the same VStacks release on the server/host and all connecting clients because the inventory network bit width is changed.
